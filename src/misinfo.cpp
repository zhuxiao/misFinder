...
{
	int32_t i, tmp, globalSegNum, subjectID, subjectLen, startItemRow, endItemRow,  misType, misjoinFlag, circularFlag;
...
{
	int32_t i, globalSegNum, subjectID, validIndelFlag;
