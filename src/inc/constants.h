...
#define MISFINDER_VERSION_STR			("0.6.0")
#define MISFINDER_RELEASE_DATE_STR		("Feb 5, 2024")


#define DEBUG_SCAF_OVERLAP_FLAG		(NO)

#define OUTPUT_DIR_DEFAULT			"output"
#define CONFIGFILENAME_DEFAULT		"config_example"
...
#define OPERATION_MODE_GENCONF			4
